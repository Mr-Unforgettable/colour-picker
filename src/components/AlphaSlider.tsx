    ...
    return (
        ...
        >
            <div
                ...
                style={{
                    backgroundImage:
                        `url("data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='16' height='16'><rect width='8' height='8' fill='%23ccc'/><rect x='8' y='8' width='8' height='8' fill='%23ccc'/><rect x='8' width='8' height='8' fill='%23eee'/><rect y='8' width='8' height='8' fill='%23eee'/></svg>")`,
                }}
            />
            <div
                ...
                style={{
                    background:
                        `linear-gradient(to top, rgba(${rgb.r}, ${rgb.g}, ${rgb.b}, 0), rgba(${rgb.r}, ${rgb.g}, ${rgb.b}, 1))`,
                }}
            />
            <div
